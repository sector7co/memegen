  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[#f5f3ee] px-5 py-10 text-[#171714]">
      <article className="w-full max-w-2xl">
        <a href="/" className="mb-5 inline-flex items-center gap-2 text-lg font-black tracking-[-0.04em]"><span className="grid size-8 place-items-center rounded-lg bg-[#ff5c35] text-white">M</span>memegen</a>
        <div className="rounded-[28px] border border-black/10 bg-white p-3 shadow-[0_20px_60px_rgba(46,38,22,.13)]">
          ...
          <div className="grid grid-cols-2 gap-2 pt-3">
            ...
            <a href="/" className="rounded-xl bg-[#171714] px-4 py-3 text-center text-sm font-black text-white">Make your own</a>
          </div>
        </div>
